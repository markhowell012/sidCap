    ...
    <div className="mx-auto">
      <div className="marginBody mx-auto grid grid-cols-1 md:grid-cols-2 items-start gap-4 py-8 md:py-16">
        <div className="mt-10">
          ...
          <p className="paragraph1">
            ...
            <br />
            <br />
            If you’re ready to start but still don’t know who to work with, turn to Cidwell capital! We use our sprawling
      ...
      <div className="marginBody mx-auto flex items-start gap-20 py-8 md:py-16 lg:py-24">
        <div className="flex flex-col sm:flex-row item-start gap-10">
          <h1 className="w-[100%] sm:w-[45%] heading2 font-medium leading-tight">
            Increase Productivity With Cidwell Capital’s Business Equipment Financing
          </h1>
          <p className="w-[100%] sm:w-[65%] paragraph1">
            ...
            Best of all, when you get equipment financing from Cidwell Capital, you can count on:
          </p>
        </div>
      </div>
      ...
      <div className="equipmentFinanceBGImage py-20 lg:py-0 flex flex-col justify-center items-center">
        ...
        <p className="max-w-[80%] md:max-w-[50%] mx-auto paragraph2 !text-white text-center mb-8">
          ...
          for a little bit of help with light restaurant equipment financing, Cidwell capital is the one-stop shop for all
      ...
      <div className="marginBody mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 py-16 gap-10 md:gap-20">
          ...
          <div>
            <h1 className="heading2 text-[36px] mb-10">Why Work With Cidwell Capital?</h1>
            <p className="paragraph1 ">
              When you work with Cidwell Capital, you gain a financial partner committed to your organizational success.
              ...
              approach that incorporates cutting-edge security platforms, Cidwell Capital is the ultimate solution to your
      ...
      <section className="marginBody mx-auto my-0 sm:my-10 flex flex-col gap-10">
        <div className="flex flex-col justify-center items-center gap-3 text-center">
          ...
          <p className="paragraph2">
            ...
            testimonials, Cidwell Capital has a track record of excellent service. Check out some of our reviews below:
          </p>
        </div>
