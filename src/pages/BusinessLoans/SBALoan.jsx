  ...
  return (
    <div className="mx-auto">
      <div className="marginBody mx-auto grid grid-cols-1 md:grid-cols-2 items-start py-16 gap-8">
        <div className="mt-10">
          <h2 className="heading2 mb-3">Secure Any Type Of SBA Loan With Cidwell Capital</h2>
          <p className="paragraph1">
            ...
            <br />
            <br />
            Luckily, Cidwell Capital is here to help. Whether you need an SBA real estate loan or are interested in an SBA
      ...
      <section className="marginBody mx-auto my-10 flex flex-col gap-10">
        <div className="flex flex-col justify-center items-center gap-3 text-center">
          <h3 className="heading2 font-medium text-black">Cidwell Capital: Proven Excellence</h3>
