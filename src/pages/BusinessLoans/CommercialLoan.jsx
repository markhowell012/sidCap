  ...
  return (
    <div className="mx-auto">
      <div className="marginBody mx-auto grid grid-cols-1 md:grid-cols-2 items-start py-8 md:py-16 gap-8">
        <div className="mt-10">
          ...
          <p className="paragraph1">
            Need help financing your commercial real estate investment? Cidwell capital can lend a hand. We have a
      ...
      <div className="marginBody mx-auto py-8 md:py-16 lg:py-24">
        ...
        <div className="py-10">
          <p className="paragraph1">
          Cidwell capital can help you get access to real estate loans at competitive rates today. We’re eager to
      ...
      <section className="marginBody mx-auto my-10 md:my-20 flex flex-col gap-10">
        <div className="flex flex-col justify-center items-start gap-3 text-left">
          ...
          <p className="paragraph1">Let’s review why Cidwell capital is the right partner for you.</p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16">
          <div>
            ...
            <p className="paragraph1">
              ...
              with Cidwell Capital to avoid them.
            </p>
          </div>
          <div>
            ...
            <p className="paragraph1">
              <span className="text-primary">
                <Link to="/about-us">People are the point at Cidwell Capital.</Link>
              </span>{" "}
              ...
              at Cidwell Capital, which is why you can trust us to meet your needs.
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-center items-start gap-3 text-left">
