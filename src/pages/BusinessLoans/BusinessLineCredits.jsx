      ...
      <div className="marginBody mx-auto grid grid-cols-1 md:grid-cols-2 items-start py-8 md:py-16 gap-8">
        <div className="mt-10">
          ...
          <p className="paragraph1">
            ...
            want to take out a traditional loan. If you’re interested but don’t know where to turn, work with Cidwell
            Capital!
            <br />
            <br />
      ...
      <div className="marginBody mx-auto py-8 sm:py-16 lg:py-24">
        ...
        <div>
          ...
          <p className="paragraph1 mt-2">
            ...
            lenders? Work with the experts at Cidwell capital! Our team can collaborate with you to get the financing
        ...
        <div className="pt-10 md:pt-20">
          <h1 className="text-center heading2 mb-4">Why Cidwell Capital?</h1>
          <p className="text-center paragraph2">Cidwell Capital already has a variety of advantages over its competitors:</p>
        </div>
        <LoanCard
          data={[
            {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 py-2 md:py-16 gap-2 md:gap-20">
          ...
          <div>
            ...
            <p className="paragraph1 ">
              ...
              industry. We recognize the importance of connections at Cidwell Capital, which is why we’ve developed deep bonds
