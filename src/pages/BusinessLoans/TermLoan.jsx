    ...
    <div className="mx-auto">
      ...
      <div className="marginBody mx-auto py-24">
        <div className="flex flex-wrap sm:flex-nowrap items-start gap-8">
          ...
          <p className="w-full sm:w-[60%] paragraph1 text-center text-justify">
            ...
            business term loan from Cidwell capital. We secure flexible loans at competitive rates fast. Once you
      ...
      <section className="marginBody mx-auto py-20">
        <div className="px-[20px] flex flex-col justify-center items-center gap-3 text-center">
          ...
          <p className="paragraph1">
            A lot of organizations can help you track down term loans—so why should you work with Cidwell capital? We
            offer a unique blend of strengths when compared to other organizations. When you work with Cidwell Capital, you
            get:
          </p>
        </div>
        <div className="marginBody mx-auto">
            ...
            <div>
              ...
              <div className="flex flex-row mb-4">
                ...
                <p className="paragraph1 ml-6">
                  ...
                  relationships at Cidwell Capital. We won’t push just any financing option on you, we work with you to find
              ...
              <div className="flex flex-row mb-4">
                <BiChevronRight className="text-primary w-[20px] min-w-[20px] mt-1" />
                <p className="paragraph1 ml-6">
                  <span className=" font-bold">Access to Sprawling Financial Connections:</span> Cidwell Capital is
