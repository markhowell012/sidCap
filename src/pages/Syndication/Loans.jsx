    ...
    <div className="marginBody flex flex-col lg:flex-row gap-8 justify-between">
      <div className="rounded-2xl shadow-main max-w-sm py-4 px-16">
        <div className="flex items-center gap-6">
          <div>
            <img src="/assets/images/businessloans.png" className="w-[130px]" />
          </div>
          <div>
            <h1 className="heading3 text-secondary">Business Loans </h1>
      ...
      <div className="rounded-2xl shadow-main max-w-sm py-4 px-16">
        <div className="flex items-center gap-6">
          <div>
            <img src="/assets/images/personaloans.png" className="w-[130px]" />
          </div>
          <div>
            <h1 className="heading3 text-secondary">Personal Loans</h1>
            <p className="paragraph1 mt-4">
      ...
      <div className="rounded-2xl shadow-main max-w-sm py-4 px-16">
        <div className="flex items-center gap-6">
          <div>
            <img src="/assets/images/credits.png" className="w-[130px]" />
          </div>
          <div>
            <h1 className="heading3 text-secondary">Line of credit </h1>
            <p className="paragraph1 mt-4">
